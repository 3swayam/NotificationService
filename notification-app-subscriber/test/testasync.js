...
"d83CR0fsQxE:APA91bFRhwAQICdrLRIbV5hjS4MRvTdVj4y894Ovwgxm6u9T0LVr9HJfXC9Sqgnf8BqA4JoVCLIwGuX8v3pd51-VQoNLIxLh4xTuf_xJPB4VkE7C8ORGoYfyugXQnvYdUIYPmAEfJPn",
"d83CR0fsQxE:APA91bFRhwAQICdrLRIbV5hjS4MRvTdVj4y894Ovwgxm6u9T0LVr9HJfXC9Sqgnf8BqA4JoVCLIwGuX8v3pd51-VQoNLIxLh4xTuf_xJPB4VkE7C8ORGoYfyugXQnvYdUIYPmAEfJPn",
"d83CR0fsQxE:APA91bFRhwAQICdrLRIbV5hjS4MRvTdVj4y894Ovwgxm6u9T0LVr9HJfXC9Sqgnf8BqA4JoVCLIwGuX8v3pd51-VQoNLIxLh4xTuf_xJPB4VkE7C8ORGoYfyugXQnvYdUIYPmAEfJPn"];

function test(){
KUNJ_KEY.forEach( (j,index) => {
   // console.log("Sendin  ",j);
    var message = { //this may vary according to the message type (single recipient, multicast, topic, et cetera)
        ...
        data: {  //you can send only notification or only data(or include both)
            timestamp: Date.now(),
            client_id: 'record.messageAttributes.userId.stringValue'+j,
            notificationId: 'record.messageAttributes.notificationId.stringValue'+index,
            message: 'Test',
 ...
 //   console.log("Payload ",JSON.stringify(message));
    ...
    for(var i=0;i<KUNJ_KEY.length;i++){
        ...
        fcm.send(message, function (err, response) {
            if (err) {
                console.log("Notification Id: ",message.data.notificationId);
                 error.push(err);
